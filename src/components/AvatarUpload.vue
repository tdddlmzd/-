...
<script>
'use strict';
import language from '@assets/libs/setavatar/language.js';
import mimes from '@assets/libs/setavatar/mimes.js';
import data2blob from '@assets/libs/setavatar/data2blob.js';
import effectRipple from '@assets/libs/setavatar/effectRipple.js';
